...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('⚡️ Courses', url='https://t.me/+bC09SHTXblJkZDc1'),
                    InlineKeyboardButton('🍁 Content', url='https://t.me/+pgUDlETppoA1MWQ9')
                ]
            ]
        )
